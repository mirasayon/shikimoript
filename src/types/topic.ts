...
export type TopicEventType = "episode" | "ongoing" | "anons" | "released" | "SiteNews" | "" | null;
export type TopicForum =
    | "all"
    | "animanga"
    | "site"
    | "games"
...
/** @interface */
export type TopicBasic = Pick<TopicData, "id" | "linked" | "event" | "episode" | "created_at"> & {
    url: string;
};
